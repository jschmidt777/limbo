...
<table>
<tr>
<td>Description:</td><td><input type="textbox" name="description" value="<?php if (isset($_POST['description'])) echo $_POST['description']; ?> "> (Please be as descriptive as possible.)</td>
</tr>
<tr>
